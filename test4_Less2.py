# Список (класс list он в [])- это упорядоченный конечный набор элементов. Давайте разбираться, по сути список -
# это тот же самый массив, в котором можно хранить элементы любых типов данных.
...
# list_1 = [7, 9, 11, 13, 15, 17]
# print(list_1[0]) # 7 (чтобы вывести первый элемент списка)
...
#     n = int(input("Введите целое число")) # пользователь вводит целое число
...
# print(list_1[6:-18]) # []
# print(list_1[0:len(list_1):6]) # [1, 7]  - сначала до конца с шагом 6
# print(list_1[::6]) # [1, 7] - сначала до конца с шагом 6



# Кортежи (каласс tuple) от в ()
...
# v = [1, 3, 5]   # это список
# v = tuple(v)    # перевели СПИСОК в КОРДЕЖ
# a,b,c = v       # задали значения переменным из кортежа
# print(a, b, c)
...
# Множества. В {} и перечисляются через запятую.я
# Множества содержат в себе уникальные элементы, не обязательно упорядоченные.
# Одно множество может содержать значения любых типов. Если у Вас есть два множества, 
# Вы можете совершать над ними любые стандартные операции, например, объединение, пересечение 
# и разность. 
...
# можно использовать определение «генератора списка»). 
...
# Задача 3: Cоздать пары каждому из чисел (кортежи)
